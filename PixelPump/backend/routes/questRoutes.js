...
// Route pour le renouvellement des quêtes (nécessite authentification)
...
// Route authentifiée pour le renouvellement des quêtes
router.post('/renew', questController.renewQuestsForDemo);
